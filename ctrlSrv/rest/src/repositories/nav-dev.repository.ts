...
> {
  ...
  public readonly positions: HasManyRepositoryFactory<Position, typeof NavDev.prototype.navId>;

  constructor(
    @inject('datasources.db') dataSource: DbDataSource, @repository.getter('PositionRepository') protected positionRepositoryGetter: Getter<PositionRepository>,
  ) {
