...
export interface IConfigurableIndoorMap<T extends Marker> extends IIndoorMap<T> {
	updateBackgroundImage(backgroundImage: HTMLImageElement, useImageAspectRatio?: boolean): IIndoorPosition;
	updateBackgroundImage(backgroundImage: string, useImageAspectRatio?: boolean): Promise<IIndoorPosition>;
	updateBackgroundImage(
		backgroundImage: string | HTMLImageElement, useImageAspectRatio: boolean
